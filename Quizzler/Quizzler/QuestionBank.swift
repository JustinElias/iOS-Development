...
//store all questions in this file

import Foundation

class QuestionBank{
    //creating property for QuestionBank that holds all data of all questions we are going to use in the app.
    //this list = an array that contains only Question objects
    var list = [Question]()
    
    init(){
        
        /*
         Format for constructing new objects:
         
         use either let or var to create a container
         give it a name: let newQuestionObject = Question "please find the instructions we have created for creating new question objects"
         Question()
        */
